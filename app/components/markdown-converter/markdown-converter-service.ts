...
module W2MD.Components.MarkdownConverter {
    export class MarkdownConverterService implements W2MD.Components.MarkdownConverter.IMarkdownConverterService {
        /**
         * @param {angular.IQService} $q
         * @param {IGetContentService} getContent
         */
        constructor(private $q:angular.IQService, private getContent:W2MD.Components.GetContent.IGetContentService) {
        }
